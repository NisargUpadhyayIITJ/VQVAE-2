...
if __name__ == '__main__':
    ...
    wandb.login(key='fe24c896170f713d4d3592df384f215741bff2de')
    wandb.init(project="VQ-VAE-2_new") 
    ...
    for eid in range(cfg.max_epochs):
        ...
        wandb.log({
            ...
            "train_r_loss": epoch_r_loss / len(train_loader),
            "train_l_loss": epoch_l_loss / len(train_loader)
        }, step=eid)
        ...
        wandb.log({
            "eval_loss": epoch_loss / len(test_loader),
            "eval_r_loss": epoch_r_loss / len(test_loader),
            "eval_l_loss": epoch_l_loss / len(test_loader)
        }, step=eid)
